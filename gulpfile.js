...
// minify CSS avec suffix min
gulp.task('minifyCssSuffixMin', () =>
...
// minify JS avec suffix min
gulp.task('minifyJsSuffixMin',() =>
      gulp.src('src/js/*.js')
        .pipe(minifyJS({
            ext: {
                min: '.min.js'
...
// compress JS and replace it // only js pas Vuejs
